...
namespace Nzh.Lakers.SqlSugar
{
    public class DbContext
    {
        ...
        {
            CreateClassFileByDBTalbe(strPath, "STD.Core.Entity");
        }
...
")
        ...
        public static void Init(string strConnectionString, DbType enmDbType = DbType.MySql) //数据库类型
        {
